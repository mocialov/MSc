...
// motion file handles
static WbMotionRef another_hand_wave, hand_wave, forwards, backwards, side_step_left, side_step_right, turn_left_60, turn_right_60;
...
static void load_motion_files() {
  hand_wave = wbu_motion_new("/Applications/Webots/projects/robots/nao/motions/HandWave.motion");
  another_hand_wave = wbu_motion_new("/Applications/Webots/projects/robots/nao/motions/AnotherHandWave.motion");
  forwards = wbu_motion_new("/Applications/Webots/projects/robots/nao/motions/Forwards50.motion");
  backwards = wbu_motion_new("/Applications/Webots/projects/robots/nao/motions/Backwards.motion");
  side_step_left = wbu_motion_new("/Applications/Webots/projects/robots/nao/motions/SideStepLeft.motion");
  side_step_right = wbu_motion_new("/Applications/Webots/projects/robots/nao/motions/SideStepRight.motion");
  turn_left_60 = wbu_motion_new("/Applications/Webots/projects/robots/nao/motions/TurnLeft60.motion");
  turn_right_60 = wbu_motion_new("/Applications/Webots/projects/robots/nao/motions/TurnRight60.motion");
}
...
static void run_command(int key) {
  ...
  switch (key) {
    ...
    case 'Q':
      ...
      break;
    case 'E':
      start_motion(another_hand_wave);
      break;
...
int main(int argc, const char *argv[]) {
  ...
  wb_motor_set_position (RShoulderRoll,-1.326);
