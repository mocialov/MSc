...
class SimplePopulation(object):
    ...
    def epoch(self, id, evaluator, generations, solution=None, reset=True, callback=None):
    ...
    def _status_report(self, id):
        """ Prints a status report """
        print "\n== Detector %d , Generation %d ==" % (id, self.generation)
